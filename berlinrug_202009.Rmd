...
knitr::include_graphics("./berlingrug_202009/tidymodels_hex.png")
```
...
```{r, echo = FALSE, fig.align = "center", out.width = "35%", dpi = 300}
knitr::include_graphics("./berlingrug_202009/yoda_fail.jpg")
```
...
knitr::include_graphics("./berlingrug_202009/tidymodels_code.png")
```
]
...
```{r, out.width = "30%"}
knitr::include_graphics("./berlingrug_202009/stages.svg")
```
...
```{r, out.width = "70%"}
knitr::include_graphics("./berlingrug_202009/stages_arrows_plug_complete.svg")
```
...
```{r, out.width = "95%"}
knitr::include_graphics("./berlingrug_202009/stages_arrows_plug_complete_code.svg")
```
